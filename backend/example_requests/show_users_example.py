...
resp = requests.get("http://localhost:9999/User")
resp_json = resp.json()
print(json.dumps(resp_json, indent=4))

print("#### Pagination example")
print("Page 1 pagesize 2")
resp = requests.get("http://localhost:9999/User?page=1&pagesize=2")
resp_json = resp.json()
...
resp = requests.get("http://localhost:9999/User?page=2&pagesize=2")
resp_json = resp.json()
print(json.dumps(resp_json, indent=4))

print("Page 99999 pagesize 2")
resp = requests.get("http://localhost:9999/User?page=99999&pagesize=2")
resp_json = resp.json()
print(json.dumps(resp_json, indent=4))


print(f"\n#### show user with id {first_user}")
resp = requests.get(f"http://localhost:9999/User/{first_user}")
resp_json = resp.json()
print(json.dumps(resp_json, indent=4))